(function(){
    ...
    .controller('rockMaleCtrl', function(musicFactory, $state, $stateParams){
        ...
        if($state.params.id !== undefined){
            ...
            musicFactory.getRockMale($state.params.id)
        ...
        self.submit = function(){
            ...
            if($state.params.id !== undefined){
                ...
                musicFactory.putRockMale($state.params.id, self.preset)
                .then(function(success){//promise success
                ...
                musicFactory.postRockMale(self.preset)
                .then(function(success){//promise success
                    $state.go('/');//success go back to main page.
                }, function(err){//promise error
                    self.err = err;
